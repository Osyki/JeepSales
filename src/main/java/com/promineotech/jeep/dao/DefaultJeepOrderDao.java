...
public class DefaultJeepOrderDao implements JeepOrderDao {
    ...
    @Override
    public Order saveOrder(Customer customer, Jeep jeep, Color color, Engine engine, Tire tire, List<Option> options, BigDecimal price) {
    ...
    private void saveOptions(List<Option> options, Long orderPK) {
        for (Option o: options) {
            SqlParams params = generateInsertSql(o,orderPK);
        }
    }
